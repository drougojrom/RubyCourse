...
def remove_train
  ...
  show_trains
  index = gets.to_i - 1
  @created_trains[index].remove_wagon if @created_trains[index]
  puts 'Wagon removed'
end
...
def remove
  ...
  puts '1 - wagon from train, 2 - Station from a route'
...
def show_wagons
  ...
  @created_wagons.each do |wagon|
    ...
    elsif puts "The is #{wagon.seats_left} seats left in the wagon"
    end
    index += 1
  end
end
